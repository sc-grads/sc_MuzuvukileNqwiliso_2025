...
-- THIS OPERATORS ARE USED WITH 'WHERE' CLAUSE
-- YOU CAN GENERATE MANY OF THEM AS YOU FILTER BUT WITHIN THE FILTER CLAUSE
SELECT FirstName, Email 
FROM Customers
WHERE City = 'Durban' OR City = 'Bloemfontein'

SELECT * FROM Orders
WHERE OrderPrice BETWEEN 100 AND 200

SELECT Email FROM Customers
WHERE NOT CIty = 'Johannesburg'

-- THIS COMMAND RETURNS UNIQUE COLUMNS OR UNDOUPLED OR UNREPEATED COLUMNS FROM THE DATABASE

SELECT DISTINCT City FROM Customers

-- THIS COMMAND DELETES EVERYTHING FROM THE COLUMN IF YOU OMIT WHERE 
-- ELSE IT DELETES THE SPECIFIED RECORD
